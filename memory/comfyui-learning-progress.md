...
---
*最后更新: 2026-04-15（第4周·AI绘画深度研究）*

## Seedance 2.0 分镜专家（2026-04-15 新增）
- **定位**: AI视频分镜提示词生成专家
- **核心能力**: 16种视频模板、分镜公式、镜头语言速查
- **优势**: 专业分镜结构、运镜精准、素材引用规范
- **限制**: 不支持写实真人脸部素材
- **学习文件**: `ai-video-prompt-engineering.md`

## AI绘画深度研究（2026-04-15 新增）
- **新增文件**: `memory/ai-art-research.md`
- **覆盖内容**:
  - FLUX.1 / SDXL / Midjourney / DALL-E 3 / 即梦 横向对比
  - FLUX.1 深度解析（ComfyUI原生集成、三版本对比、实测优势）
  - 提示词工程最佳实践（结构公式/权重语法/负向模板）
  - 风格研究（8大风格+3D模型师专项风格词汇）
